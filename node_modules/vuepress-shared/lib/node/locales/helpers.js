...
${lang === "root"
            ? ""
            : `You can contribute to https://github.com/vuepress-theme-hope/vuepress-theme-hope/blob/main/packages/${plugin || "<YOUR PLUGIN>"}/src/node/locales.ts in this repository.
...
const path2Lang = (path = "", debug = false) => {
...
const lang2Path = (lang = "", debug = false) => {
...
const getRootLang = (context) => {
    ...
    if ((siteLocales === null || siteLocales === void 0 ? void 0 : siteLocales["/"]) && ((_a = siteLocales["/"]) === null || _a === void 0 ? void 0 : _a.lang))
...
const getLocalePaths = (context) => Array.from(new Set([...Object.keys(context.siteConfig.locales || {})]));
 ...
 */
const getLocales = ({ context, name, default: defaultLocalesConfig, config: userLocalesConfig = {}, }) => {
    const rootPath = (0, exports.getRootLangPath)(context);
    const logger = new logger_1.Logger(name);
    return Object.fromEntries([
        ...(0, exports.getLocalePaths)(context)
            ...
            return [
                localePath,
                (0, utils_1.deepAssign)({}, defaultLocalesConfig[localePath] ||
        ...
        [
            "/",
            (0, utils_1.deepAssign)({}, defaultLocalesConfig[rootPath], userLocalesConfig["/"] || userLocalesConfig[rootPath] || {}),
        ],
    ]);
};
